This guide explains how to deploy prototypes to Heroku.
...
You can use Heroku to host your prototypes.

### Before you start

You'll need to be a member of the CPS Heroku team and have your prototype in [CPS Innovation GitHub account](https://github.com/CPS-Innovation).

If you don't have access to these, ask the design lead for help.
...
1. go to the homepage in Heroku
...
4. leave the pipeline owner set to the default selection
5. in the connect to GitHub section select `CPS-Innovation` and type the name of your repo which is normally `{organisation-abbreviation}-{service-name}-prototype` and click search
